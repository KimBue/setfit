...
class SetFitTrainer:
    def __init__(
        ...
        eval_dataset=None,
        metric: str = "accuracy",
        sentencePairGenerationFunc=None,
        ...
        self.sentencePairGenerationFunc = sentencePairGenerationFunc if sentencePairGenerationFunc is not None else sentence_pairs_generation
